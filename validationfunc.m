%% Funktion för den analytiska lösningen.
...
function p = validationfunc(mu,U,L,hmin,k)
...
% Tryckuppgyggnadens variation med alla designparametrar utom k.
tryckUppg = ((6.*mu.*U.*L)./(hmin.^2)); 
